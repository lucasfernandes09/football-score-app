...
public class AtkDef {
    ...
    private static float apvDesarmes1, desarmes1, desarmes2;
    ...
    public static ArrayList<Float> getAtkDef(Jogos jogo) {
        ...
        gFeitos2 = Float.parseFloat(jogo.getMatch_hometeam_score());
        tGols = gFeitos1 + gFeitos2;
        float apvGFeitos1 = gFeitos1 / tGols;
        golsNaoSofridos1 = tGols - gFeitos2;
        golsNaoSofridos2 = tGols - gFeitos1;
        ...
        //Média DEF
        float def1 = (apvFBloqueadas1 + apvDefGoleiro1 + apvDesarmes1 + apvGNaoSofridos1)/4;
        float def2 = 1 - def1;
